...
#define USE_STD_VECTOR_IMPL // comment out this line if want to use unordered_map implementation.
  // unordered_map is useful if the ID of the elements in the tree are not auto-generated by the tree and varies over a large range.
...
protected:
  ...
  virtual void _verifyLessThan(AVLNode* n);
    ...
    std::vector<DataType> _key;
    // std::vector<bool> _has;
  #else
    std::unordered_map<long, DataType> _key;
  #endif
